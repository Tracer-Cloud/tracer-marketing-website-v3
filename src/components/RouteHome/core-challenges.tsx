...
const ChallengeCard = ({ challenge, index }: { challenge: CoreChallenge; index: number }) => {
  ...
  return (
    <div className="md:flex">
      <div className="tracking-[-9px] border border-b-0 border-[#404040] font-chakra-petch text-[40px] md:w-44 md:border-0 md:text-center md:text-[112px]">
      ...
      >
        ...
        <div ref={ref} className="m-4 overflow-hidden border border-[#404040] relative">
          ...
          <div className="relative overflow-hidden">
            ...
            <motion.div
              className="absolute left-0 right-0 bottom-0 bg-foreground"
              initial={{ height: '85%' }}
              animate={controls}
            />
          </div>
...
const CoreChallengeSection = () => {
  return (
    <section className="bg-foreground py-6 text-background overflow-hidden">
