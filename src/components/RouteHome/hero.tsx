...
const HeroSection = () => {
  return (
    <section className="h-[643px] bg-black text-white lg:h-[808px]">
      <div className="container_fluid relative flex h-full flex-col items-center justify-center overflow-hidden lg:block">
        <div className="">
          <h1 className="relative z-10 font-chakra-petch text-[clamp(3.5rem,10vw,8.5rem)] font-medium leading-none md:-translate-y-1/2 md:leading-normal lg:absolute lg:left-4 lg:top-1/2 lg:font-normal lg:-tracking-[9px]">
            Accelerating
          </h1>
          <h2 className="relative z-10 font-chakra-petch text-[clamp(3.5rem,10vw,8.5rem)] font-medium leading-none md:-translate-y-1/2 lg:absolute lg:bottom-0 lg:right-4 lg:text-right lg:font-normal lg:leading-[104px] lg:-tracking-[10px]">
            the New Dawn <br className="hidden md:block" /> of AI in Science
          </h2>
          <div className="relative z-10 font-chakra-petch text-base lg:absolute lg:bottom-40 lg:left-4">
