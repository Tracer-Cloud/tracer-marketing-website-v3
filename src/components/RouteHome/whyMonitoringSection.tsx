...
const WhyMonitoringSection = () => {
  return (
    <section className="relative overflow-y-clip bg-[#FCFCFC] pb-4 md:pb-[86px]">
      <div className="border-grey-100 border-y">
        <div className="container_fluid flex w-full items-center gap-14 bg-[#FCFCFC] py-3 md:gap-24 md:py-2.5">
          <Image
          ...
          />
          <div className="font-chakra-petch flex w-full justify-between gap-2 text-sm font-normal uppercase tracking-[-0.01em] text-[#202020]">
            <span>the</span>
      ...
      <div className="container_fluid pt-10">
        ...
        <div className="relative font-britti-sans text-6xl font-normal leading-[0.8em] tracking-[-0.04em] text-[#202020] lg:text-8xl">
        ...
        <div className="flex flex-col gap-14 pt-10 md:pt-[220px] lg:gap-[72px] lg:pt-[330px]">
          <div className="flex flex-col gap-10 md:flex-row md:justify-between lg:gap-20">
            <div className="font-britti-sans text-xl font-normal leading-none tracking-[-0.02em] text-[#202020] md:max-w-[520px] md:text-2xl lg:text-[32px]">
          ...
          <div className="flex flex-col-reverse gap-10 md:flex-row md:items-end md:justify-between lg:gap-20">
            ...
            <div className="w-full max-w-[700px] flex-1">
              ...
              <div className="my-6 flex flex-col space-y-2 text-sm font-normal text-[#202020] md:w-full md:text-base lg:my-10 xl:w-3/5">
      ...
      <span className="absolute -bottom-px left-0 hidden h-[62px] w-[33%] bg-[#202020] md:block"></span>
    </section>
  );
};
