...
const Approach = () => {
    return (
        <div className='bg-white pt-10 pb-4 md:py-[72px] w-full text-black border-t border-[#E8E8E8] flex items-center relative justify-center flex-col'>
            <div className='w-full h-full max-w-[1800px] grid grid-cols-3 absolute top-0 900:px-0 px-2'>
            ...
            <div className='w-full flex z-[10]  flex-col items-center justify-center max-w-[1800px] 900:px-0 px-2'>
                ...
                <div className='grid 900:grid-cols-3 bg-white min-h-[120px] w-full gap-4 md:gap-6'>
                    <div className='border border-[#E8E8E8] p-4 flex flex-col gap-4 md:gap-[20px] items-start justify-between'>
