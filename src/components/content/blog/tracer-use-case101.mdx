...
tag: use-case
ogImage: /images/tracer-blog-5.png
...
<BlogHeader
  title="Observability For Biology - Real-Time Workflow Debugging Use-Case 101"
  description="Error Detection and Workflow Debugging use-case with Tracer"
  date="September 08, 2024"
  authors={["vincenthus", "laurabogaert", "tusharwarrier"]}
/>

<Frame fullWidth className="mb-12">
  ![Tracer](/images/tracer-blog-5.png)
</Frame>
...
<Frame fullWidth className="mb-12">
  ![Tracer](/images/tracer-usecase-metrics.png)
</Frame>
...
<Frame fullWidth className="mb-12">
  ![Tracer](/images/tracer-usecase-logs.png)
</Frame>

<Frame fullWidth className="mb-12">
  ![Tracer](/images/tracer-usecase-flowsheet.png)
</Frame>
...
<Frame fullWidth className="mb-12">
  ![Tracer](/images/tracer-usecase-errordb.png)
</Frame>

<Frame fullWidth className="mb-12">
  ![Tracer](/images/tracer-usecase-terminal.png)
</Frame>
...
<Frame fullWidth className="mb-12">
  ![Tracer](/images/tracer-usecase-previews.png)
</Frame>
