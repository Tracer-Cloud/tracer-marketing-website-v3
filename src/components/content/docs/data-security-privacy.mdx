...
At Tracer, we prioritize data privacy and security. We understand that the data you entrust to us is a vital asset to your business, and we treat it with the utmost care.
...
- Our database and application run on AWS infrastructure, managed by Supabase and Vercel.
  - Default data regions:
    | Tracer Region | Domain | Data location |
    | --- | --- | --- |
...
We encourage employees and third parties to report breaches to us via email (legal@langfuse.com) or postal mail (address available [here](/imprint)). You can contact us anonymously or request that we protect your privacy. For more information, employees can refer to Tracer's internal Responsible Disclosure Policy.
